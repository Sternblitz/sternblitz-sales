...
export default function LiveSimulator() {
  ...
  @keyframes breathe {
    0% { transform: scale(.985); box-shadow: 0 0 0 rgba(73,168,76,0); }
    50% { transform: scale(1); box-shadow: 0 10px 28px rgba(73,168,76,.18); }
    100% { transform: scale(.985); box-shadow: 0 0 0 rgba(73,168,76,0); }
  }
  ...
  .rating-card {
    ...
    height: 174px;
    max-width: 274px;
    border: 1px solid rgba(225,67,46,.12);
    border-radius: 8px;
  }
  .card-header {
    display: flex;
  ...
  /* === Angepasst: Sichtbarkeits-Pills === */
  .visibility-pill {
    display: inline-flex;
    align-items: center;
    justify-content: center;
    gap: 6px;
    margin: 8px auto 12px;      /* zentriert */
    padding: 6px 12px;           /* kompakt */
    border-radius: 999px;
    background: rgba(255, 71, 63, 0.12);
    font-family: 'Outfit', sans-serif;
    color: #FF473F;
    font-size: 14px;
    line-height: 1;
  ...
  .delete-option.active {
    box-shadow: 0 0 0 2px rgba(73,168,76,.25) inset;
    border-color: #49A84C;
  }
  ...
  .option-sub div:first-child {
    font-size: 15px;
    font-weight: 800;
    text-decoration: underline;
    text-underline-offset: 3px;
    text-decoration-thickness: 2px;
    text-decoration-color: rgba(73,168,76,.55);
  }
  ...
  @media (max-width: 991px) {
    ...
    .visibility-pill { font-size: 13px; padding: 6px 10px; }
  }
  ...
  @media (max-width: 479px) {
    ...
    .visibility-pill { font-size: 12px; padding: 6px 10px; }
  ...
  .rating-text .text, #bad-count {
    font-size: 21px;
    font-weight: 800;
    color: #e13121;
    line-height: 1;
  }
  .rating-text .icon, .rating-text .close {
    font-size: 16px;
    color: #FF473F;
    line-height: 1;
  }
