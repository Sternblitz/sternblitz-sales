...
export default function LiveSimulator() {
  ...
  .review-container {
    ...
    z-index: 2; /* >>> über dem Seitenverlauf */
  }
  ...
  /* --- weiße Box hinter Suchfeld (fixiert gegen Gradient) --- */
  .review-card {
    position: relative;
    z-index: 3; /* >>> sicher über shell::before */
    background: #ffffff;
  ...
  .search-box {
    ...
    background: #fff; /* fix: bleibt weiß unter Gradient */
    position: relative;
    z-index: 4;
  }
  ...
  /* --- alles was folgt bleibt exakt wie vorher --- */
  ...
  /* Sicherstellen, dass der Seitenverlauf im Dashboard darunter bleibt */
  .shell::before { z-index: 0 !important; }

  /* Responsive wie gehabt */
