  ...
  return (
    <main className="login-bg">
      ...
      <style jsx>{`
        ...
        .login-box {
          width: 100%;
          max-width: 460px;            /* schmaler = hübscher/zentriert */
          background: #fff;
          border-radius: 18px;
          padding: 26px 20px 22px;
          box-shadow: 0 6px 30px rgba(0,0,0,.12);
          box-sizing: border-box;      /* kein Overflow */
        }
        ...
        .head {
          ...
          align-items: center;
          margin-bottom: 14px;         /* kleinerer Abstand zum Formular */
        }
        ...
        .subtitle {
          ...
          color: rgba(1,1,1,.75);
          font-weight: 600;
          margin: 6px 0 0;             /* dichter an der Headline */
          line-height: 1.3;
        }

        .form {
          width: 100%;
          max-width: 360px;            /* zentrierte schmale Inputs */
          margin: 8px auto 0;
          display: flex;
          flex-direction: column;
          gap: 8px;
        ...
        .login-text {
          font-size: 20px;             /* größerer „Login“-Text */
          font-weight: 800;
          color: #000;
          margin: 0 0 8px 0;
          text-align: center;
        ...
        .input:focus {
          border-color: #49a84c;
          box-shadow: 0 0 0 2px rgba(73,168,76,.22);
        }
        ...
        .cta {
          ...
          color: #fff;
          font-weight: 700;
          font-size: 16.5px;           /* größerer Button-Text */
          border: 0;
          cursor: pointer;
        ...
        .hint {
          ...
          color: #6b7280;
          text-align: center;
          line-height: 1.2;            /* straffer Zeilenabstand */
        }
